    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        completeProfile.setOnClickListener(v -> {
            if(TextUtils.isEmpty(fname.getText())){
                ...
                Toast.makeText(getApplicationContext(),"Click on image to upload profile picture",Toast.LENGTH_LONG).show();
            } else{
                ...
                reference.setValue(userData).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        startActivity(new Intent(ProfileActivity.this, PetInformationActivity.class));
                    }
                });
