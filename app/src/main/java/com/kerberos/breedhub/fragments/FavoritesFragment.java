 ...
 */
public class FavoritesFragment extends Fragment implements PetsAdapter.ItemClickListener{

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    ArrayList<PetModel> cats;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        cats = new ArrayList<>();
        final PetsAdapter[] petsAdapter = new PetsAdapter[1];
        ...
        reference.child("fav").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                petsAdapter[0] = new PetsAdapter(requireActivity(), cats);
                recyclerView.setAdapter(petsAdapter[0]);
                petsAdapter[0].setClickListener(FavoritesFragment.this::onItemClick);
            }
    ...
    public void onItemClick(View view, int position) {
        ...
        intent.putExtra("id", cats.get(position).getId());
